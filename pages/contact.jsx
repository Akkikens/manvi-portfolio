          ...
          <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
            <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-LightGray md:text-sm">Boston</span>
              </div>
              <div className="flex justify-between items-center">
            ...
            <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-LightGray text-sm">
                  <a
                    href="mailto:mpanjwani@clarku.edu"
                    className="text-LightGray text-sm"
                  >
                    mpanjwani@clarku.edu
                  </a>
                </span>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <a
                  href="https://www.linkedin.com/in/manvi-panjwani/"
                  className="text-LightGray text-sm"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  https://www.linkedin.com/in/manvi-panjwani/
                </a>
              </div>
              <div className="flex justify-between items-center">
                <span className="md:text-base">Phone:</span>
                <a href="tel:+13312032895" className="text-LightGray text-sm">
                  +1 (331) 203-2895
                </a>
              </div>
            </div>
